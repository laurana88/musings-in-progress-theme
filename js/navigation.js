 ...
 */
 ( function() {
	...
	const searchButton = document.getElementsByClassName('search-toggle');
	...
	// Toggle the .show-menu class and the aria-expanded value each time the button is clicked.
	...
	// Remove the .show-menu class and set aria-expanded to false each time the button is clicked.
